...
var secure_1 = require("../security/secure");
...
UserSchema.methods.setPassword = function (password) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, secure_1.default.hashPassword(password, 10)];
                case 1:
                    hash = _a.sent();
...
UserSchema.methods.validatePassword = function (password) {
    return __awaiter(this, void 0, void 0, function () {
        var hash, authenticated;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    hash = this.hash;
                    return [4 /*yield*/, secure_1.default.comparePasswords(password, hash)];
                case 1:
